    ...
    <div className={deleteStyles.container}>
      <div className={deleteStyles.container__background}>
        <div className={deleteStyles.container__head}>
            <h3 className={deleteStyles.container__headTitle}>Удалить проект?</h3>
            <Link to="/Details">
            <img src={closeIcon} alt="" />
            </Link>
        </div>
        <h3 className={deleteStyles.container__centerText}>Вы действительно хотите удалить проект?</h3>
